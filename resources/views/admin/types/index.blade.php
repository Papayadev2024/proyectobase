...
@section('content')
    ...
    <div class="card-header">
        <a href="{{route('admin.categorias.create')}}"  class="btn btn-primary"> Nuevo Tipo </a> 
    </div>
    <div class="card">
      <div class="card-body">
            ...
            @foreach ($types as $type)
                <tr>
                    ...
                    <td style="display: flex; align-items: center; gap: 8px;">
                        <a  href="{{route('admin.categorias.edit', $type)}}" class="btn btn-primary btn-sm" ><i class="far fa-edit"></i></a>
                        <form method="POST" action=""> 
                            @csrf 
                            <a class="btn btn-danger btn-sm btn_delete" data-idUser='{{$type->id}}'><i class="far fa-trash-alt "></i></a>
                        </form>
                    </td>     
                </tr>         
            @endforeach
